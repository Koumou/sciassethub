    ...
    <section class="container pb-5">
        ...
        <div class="row align-items-center">
            ...
            <div class="order-card auto-fill">
                <?php
                // dd($all_chemical_available_four);
                ?>
                @foreach($all_chemical_available_four as $asset_available)
                ...
                <div class="panel panel-default card-input card">
                    ...
                    <div class="card-body border-0">
                        ...
                        <div>
                            ...
                            @Auth
                            @if($asset_available->user_reference != Auth::user()->email)
                            <a href="/all_asset_available/asset_preview/{{$asset_available->asset_reference}}" class="btn btn-secondary btn btn-block no-radius">
                                <?php
        ...
        <div class="order-card auto-fill">
            <?php
            // dd($all_asset_available_four);
            ?>
            @foreach($all_asset_available_four as $asset_available)
                ...
                <div class="card-body border-0">
                    ...
                    <div>
                        ...
                        <a href="all_asset_available/asset_preview/{{$asset_available->asset_reference}}" class="btn btn-secondary btn btn-block no-radius">
                            ...
                            Illuminate\Support\Facades\Cache::forget('asset_reference');
                            $asset_preview = ['assets_display' => $all_asset_available];
                            Illuminate\Support\Facades\Cache::put('asset_reference', 'uoo', $minutes = 2880);
                            ?>
                            {{ __('Request asset') }}
                        </a>
                        @endauth
