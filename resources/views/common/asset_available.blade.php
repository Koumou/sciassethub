    ...
    <div class="col-lg-12 col-md-12 col-sm-12 py-2 px-0">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                @if($cat_reference == "Chemistry" || $cat_reference == "Computer Science" || $cat_reference == "Biotechnology")
                <li class="breadcrumb-item active" aria-current="page">{{$cat_reference}}</li>
                @else
...
<div class="py-0">
    ...
    <section class="container py-0">
        ...
        <div class="order-card auto-fill">
            ...
            <a href="/all_asset_available/asset_preview/{{$asset_avail->asset_reference}}">
