...
<!-- dd($all_space_requested_owner); -->
      ...
      <tr class="py-0 my-0">
        ...
        <td data-label="Supervisor approval"><small>{{gzuncompress(Illuminate\Support\Facades\Crypt::decrypt($space_request_->co2))}}</small></td>
  ...
  <table>
    ...
    <tbody>
      @foreach($all_space_requested_requested as $space_request_)
      <!-- $track_space_requested = $all_space_requested_requested->where('space_request_id', $space_rent_reference); -->
