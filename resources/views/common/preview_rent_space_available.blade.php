    ...
    <div class="container py-2">
        <div class="row py-4">
            ...
            <div class="row ">
                ...
                $type_decrypt = Illuminate\Support\Facades\Crypt::decrypt($rent_space_availk_->type_storage);
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-12 col-sm-12">
                            ...
                            <div class="container-controler py-2 ml-0">
                                ...
                                <p class="text-dark my-1 py-1 mx-0">
                                    <b>{{gzuncompress($type_decrypt)}}: Brand ({{gzuncompress($storage_brand_decrypt)}}) </b> @if(gzuncompress($co2_decrypt) == "Yes")
                            ...
                            <div class="pb-4">
                                ...
                                <div>
                                    <!-- <small class="pb-3 mb-3">
                                        CO<sub>2</sub> avail: {{gzuncompress($co2_decrypt)}}
                                    </small> -->
                                </div>
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12">
                            <div class="panel panel-default card-input card initial border border-secondary no_hover border-1 my-2">
                                <?php
                                // dd(count($all_space_requested_requested));
                                ?>
                                @if(count($all_space_requested_requested) == 0 || count($all_space_requested_requested) != 0)

                                <?php

                                $space_requested_by_current_user = $all_space_requested_requested->where('requester_id', Illuminate\Support\Facades\Auth::user()->email);
                                $track_space_requested = $space_requested_by_current_user->where('space_request_id', $space_rent_reference);
                                $_space_requested = $track_space_requested->where('space_request_id', $space_rent_reference);
                                $subset_space_taken = $_space_requested->pluck('date_start');
                                ?>

                                @if(count($track_space_requested) == 0)
                                <div class="card-body border-0">
                                    <!-- <h3 class="text-dark mx-0">
                                        <b><span class="badge badge-pill badge-dark"> <b class="text-white">ZAR tiir /day </b></span></b>
                                    </h3> -->
                                    ...
                                    <form id="msform" method="POST" action="/rent_space_available/preview_rent_space_available/{{$space_rent_reference}}/{{$rent_space_availk_->user_reference}}/sent_request" enctype="multipart/form-data" data-netlify-recaptcha="true" data-netlify="true">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="date" name="rent_start_date_confirmed" id="date_input" min="{{gzuncompress($start_decrypt)}}" value="{{gzuncompress($start_decrypt)}}" />
                                            </div>

                                            <div class="form-group col-md-12">
                                                <label class="fieldlabels">Estimate check-out Date *</label>
                                                <input type="date" name="rent_end_date_confirmed" min="{{gzuncompress($start_decrypt)}}" value="{{gzuncompress($end_decrypt)}}" />
                                            </div>
                                        ...
                                        @if($rent_space_availk_->email == Auth::user()->email)
                                        <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="The system does not permit requesting your own posted space.">Request space</a>
                                ...
                                <div>
                                    <div class="card-body border-0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div><small>Estimated check-in</small></div>
                                                <div><b><?php echo date('F d, Y', strtotime($requested_space->date_start)) ?></b></div>

                                            </div>
                                            <div class="col-md-6">
                                                <div><small>Estimated check-out</small></div>
                            ...
                            <!-- <div class="order-card auto-fill">
                                <?php
                                $space_rent_other_suggestion = $all_available_space_recommendation->where('space_request_id', '!==', $space_rent_reference);
                                $current_space_rent_selected = $space_rent_other_suggestion->where('space_request_id', '!==', $space_rent_reference);
                                ?>
                                @if(count($current_space_rent_selected) != 0)
                                @foreach($current_space_rent_selected->take(1) as $rent_space_availk_)
                                <div class="pt-5 pb-0 mb-0">
                                    <h5 class="pb-0 mb-0"><b>Other offer</b></h5>
                                </div>
                                <div class="panel panel-default card-input card initial border border-secondary border-1 my-2">
                                    <div class="card-body">
                                        <span class="text-dark mx-0">
                                            <b>{{gzuncompress($type_decrypt)}} @if(gzuncompress($co2_decrypt) == "Yes")
                                                <span class="badge badge-pill badge-dark mt-2">CO<sub class="text-white">2</sub></span>
                                                @endif</b>
                                            <br />
