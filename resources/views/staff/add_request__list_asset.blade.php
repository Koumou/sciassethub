...
<div class="container py-5">
    <div class="col-lg-12 col-md-12 col-sm-12 py-2 px-0">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item active" aria-current="page">View my asset (equipment)</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 px-0 mx-0">
        ...
        <a href="/dashboard/my_asset/category_equipment/form_add_equipment" class="btn btn-secondary no-radius float-right">
            {{ __('Add asset') }}
        </a>
    </div>
    ...
    <section class="container py-0 mx-0 px-0">
        <div class="row align-items-center py-2 pb-4 px-0">
            <div class="col-lg-6 col-md-6 col-sm-6 px-0">
                <h6><b><small><b>All your assets (equipment)</b></small></b></h6>
            </div>
        </div>
        ...
        $extract_equipment = $decryptedRentSpaces->where('asset_category', "Equipment");
                ...
                <div class="panel panel-default card-input ">
                    <div class="card-body ml-4 border-0">
                        <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                            <i class="fa fa-folder-open mr-4" style="font-size:24px"></i> <b>Equipment > View</b>
                        </button>
                    </div>
                </div>
                <div class="panel panel-default card-input">
