                ...
                <div>
                    <div class="col-lg-12 col-md-12 col-sm-12 p-0 py-4">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>Congrats!</strong> Equipment was added successfully.
                    ...
                    <h4><b>Add equipment information</b></h4>
                    <form id="msform" method="POST" action="{{ route('add_equipment') }}" enctype="multipart/form-data" data-netlify-recaptcha="true" data-netlify="true">
                        {{ csrf_field() }}
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="py-2 pb-4">
                                    <div>
                                        <h2 class="fs-title"><b>General information related to equipment</b></h2>
                                        <p>Please verify that all required fields have been correctly filled out.</p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="fieldlabels">Equipment name: <b class="text-danger">*</b></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="asset_category" onfocus='this.size=6;' onblur='this.size=0;' onchange='this.size=1; this.blur();'>
                                        ...
                                        <option disabled>Anatomy</option>
                                        <option value="equipment" selected>Equipment</option>
                                        <option disabled>Chemical</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label class="fieldlabels">Equipment current location: <b class="text-danger">*</b></label>

                                    <select name="equipment_current_location" onfocus='this.size=6;' onblur='this.size=0;' onchange='this.size=1; this.blur();'>
                                        <option value="Bellville" selected>Bellville</option>
                                        <option value="HCS" disabled>HCS</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="equipment_max" placeholder="Enter the maximum value of the equipment you currently have" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="equipment_min" placeholder="Enter the minimum amount that can be purchased" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="measurement" onfocus='this.size=6;' onblur='this.size=0;' onchange='this.size=1; this.blur();'>
                                        <option value="">-- Select equipment units of measurement --</option>
                        ...
                        <fieldset>
                            <div class="form-card">
                                <div class="py-2 pb-4">
                                    <div>
                                        <h2 class="fs-title"><b>Equipment labeling</b></h2>
                                        <p>Please verify that all required fields have been correctly filled out.</p>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <textarea id="exampleFormControlTextarea1" placeholder="Enter chemical formula ..." rows="2"></textarea>
                                </div> -->
                        ...
                        <fieldset>
                            <div class="form-card">
                                <div class="py-2 pb-4">
                                    <div>
                                        <h2 class="fs-title"><b>Equipment representation</b></h2>
                                ...
                                <div class="form-group">
                                    <label class="fieldlabels">Would you like an 360 view to be added to your equipment? (optional)</label>
                                    <p>
                                ...
                                <div class="form-group">
                                    <label class="fieldlabels">Would you like an AR demo to be added to your equipment? (optional)</label>
                                    <p>
                                ...
                                <div class="form-group">
                                    <label class="fieldlabels">Does the equipment include training? (optional)</label>
                                    <p>
