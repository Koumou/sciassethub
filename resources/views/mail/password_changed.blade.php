                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <!-- <h1 style="margin-top:0;margin-bottom:1.1em;font-size:1.5em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;">Reset your password</h1> -->
                                <!-- <br /> -->
                                <p>Hello member of SciAssetHub,</p>

                                <p>
                                    The password for your SciAssetHub account ({{$details['user_email']}}) was just changed.
                                    <div>If this was, then you can safely ignore this email.</div>
                                    <div>If this was not you, your account may have been compromised. Please take action by resetting your password.</div>
                                </p>
                                <p style="text-align: center;margin: 2.5em auto;">
                                    <!-- <a class="button" href="/set_password" style="background: #DE4D3B; 
