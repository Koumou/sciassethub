                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <br />
                                <p>Dear {{$details['supervisor_fullname_']}},</p>

                                <p>We'd like to inform you that {{$details['student_fullname_']}}
                                    has requested an asset named "{{$details['asset_name']}}" To review and take action, please access your SciAssetHub account (www.sciassethub.com).
                                    The requested asset is available under the 'My Student' section.</p>
                                <br />
