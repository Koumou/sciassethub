                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <p>We are excited to announce the addition of a new asset to our platform. {{$details['owner_firstname']}} {{$details['owner_lastname']}} has uploaded a new asset "{{$details['asset_name']}}" on {{$details['date_asset_created']}}.</p>

                                <p style="text-align: center;margin: 2.5em auto;">
                                    <a class="button" href="https://sciassethub.com/" style="background: #DE4D3B; 
                       text-decoration: none; 
                       padding: 0.9em 1em;
                       color: #ffffff; 
                       border-radius: 48px;">
                                        <span style="font-weight:bold;">Request asset</span>
                                    </a>
                                </p>
                                <div></div>
                            </td>
                            ...
                            <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:#ffeada;color:#384049;border: 1em solid #fff;" class="center">
                                ...
                                <center>
                                    ...
                                    <p style="margin:0;font-size:.75rem;line-height:1.5em;text-align: center;">
                                        This email is intended for {{$details['subscriber_reference']}}. You are receiving this email because your current project is based on {{$details['asset_equipment']}}.
