                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1 style="margin-top:0;margin-bottom:1.1em;font-size:1.5em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;">Account Activation</h1>
                                <br />
                                <p>Hi new member of SciAssetHub,</p>

                                <p>Thank you for joining our community. Your account is currently inactive. Please click on the button below to activate your account.</p>
