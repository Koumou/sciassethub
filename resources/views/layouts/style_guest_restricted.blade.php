        ...
        <div class="container pb-1"> <a class="navbar-brand d-flex align-items-center" href="/">
          ...
          <div class="collapse navbar-collapse pt-4 mt-3" id="navbar4">
            ...
            <ul class="navbar-nav ml-auto mr-3 mt-3 mt-lg-0">
              ...
              <li class="nav-item px-lg-2 pt-2 {{ URL::route('login') === URL::current() ? 'active' : '' }}"> <a class="nav-link" href="/login"><span class="d-inline-block d-lg-none icon-width"><i class="fa fa-user-lock"></i></span>Login</a> </li>
          ...
          <div class="collapse navbar-collapse px-0 mx-0" id="navbar4">
            ...
            <ul class="navbar-nav ml-auto mr-3 mt-0 mt-lg-0">
              <ul class="navbar-nav mr-auto">
                ...
                @if(URL::route('dashboard') === URL::current() || URL::route('profile') === URL::current())
                ...
                @elseif(URL::route ('add_request__list_asset') === URL::current() || URL::route ('category') === URL::current() || URL::route ('form_add_equipment') === URL::current() || URL::route ('dashboard.asset_requested') === URL::current())
                ...
                <li class="nav-item pt-3 {{ URL::route('view_asset_requested') === URL::current() ? 'active' : '' }}">
                  <a class="nav-link" href="/view_asset_requested">
                    <span class="d-inline-block d-lg-none icon-width">
                      ...
                      ?>
                      {{count($filter_asset_requested)}}</span></a>
                </li>
                @endif

                @elseif(URL::route ('message') === URL::current() || URL::route ('search.index') === URL::current())
        ...
        <div class="container pb-1"> <a class="navbar-brand d-flex align-items-center" href="/">
          ...
          <div class="collapse navbar-collapse pt-4 mt-3" id="navbar4">
            ...
            <ul class="navbar-nav ml-auto mr-3 mt-3 mt-lg-0">
              ...
              <!-- <li class="nav-item px-lg-2 pt-2"> <a class="nav-link" href="/register"><span class="d-inline-block d-lg-none icon-width"><i class="fas fa-home"></i></span><i class="fa fa-search"></i></a> </li> -->
              <li class="nav-item px-lg-2 pt-2"> <a class="nav-link" href="/search"><span class=""></span><i class="fa fa-search"> <?php
                                                                                                                                    // Illuminate\Support\Facades\Cache::forget('asset_search');
                                                                                                                                    // Illuminate\Support\Facades\Cache::forget('input_inserted');
                                                                                                                                    ?></i></a> </li>


              <!-- <li class="nav-item pt-1"> <a class="nav-link" href="/register">
          <button class="btn btn-sm btn-secondary" type="button">Create account</button>
        </a>
      </li> -->
            </ul>
          ...
          <div class="collapse navbar-collapse px-0 mx-0" id="navbar4">
            ...
            <ul class="navbar-nav ml-auto mr-3 mt-0 mt-lg-0">
              <ul class="navbar-nav mr-auto">
                ...
                @if(URL::route('dashboard') === URL::current() || URL::route('history') === URL::current() || URL::route('profile') === URL::current() || URL::route ('message') === URL::current() || URL::route ('search.index') === URL::current())
                ...
                <li class="nav-item pt-3 {{ URL::route('view_space_requested') === URL::current() ? 'active' : '' }}">
                  <a class="nav-link" href="/view_space_requested">
                    <span class="d-inline-block d-lg-none icon-width">
                      <i class="fa fa-store"></i></span>View space requested</a>
                </li>
